...
- Production-oriented diagnostic workspace for HOI4 and Victoria 3.
- Game-aware project + `error.log` diagnosis with root-cause prioritization.
- Regression baselines, ignored fingerprints, local reference comparison and exports.
...
- Korean localization pilot: browser-language routing, persistent English/Korean preference, a localized diagnostic workspace, and four Korean HOI4 troubleshooting pages with hreflang/canonical coverage.
